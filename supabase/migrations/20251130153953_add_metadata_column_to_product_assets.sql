...
--
-- NOTE (schema consolidation, Watchtower task c759b3d4): this file was committed as a 0-byte
-- placeholder in supabase/migrations while the real SQL lived only in the duplicate copies at
-- backend/supabase/migrations/ and backend/migrations/. Content restored here; those copies deleted.
