...
const VendorMessages: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Vendor Messages</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-500">Product Inquiries</p>
              <p className="text-lg font-semibold text-gray-900">{tagCounts.product_inquiry || 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-500">Support Requests</p>
              <p className="text-lg font-semibold text-gray-900">{tagCounts.order_support || 0}</p>
            </div>
          </div>
        </div>
      </div>

      <div className="bg-white rounded-lg shadow h-[700px] flex">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {getQuickReplies().map((reply, index) => (
                      <button
                        ...
                        className="text-left p-2 text-sm bg-white border border-gray-200 rounded hover:bg-gray-50"
                      >
                        {reply}
                      </button>
                    ))}
              ...
              <div className="p-4 border-t border-gray-200 bg-gray-50">
                <div className="flex items-end space-x-2">
                  ...
                  <button
                    ...
                    className={`p-2 hover:text-gray-600 ${showQuickReplies ? 'text-purple-600' : 'text-gray-400'}`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
