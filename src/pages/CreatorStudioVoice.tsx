...
/**
 * Creator Studio, VOICE lane — build a real product by talking to Mr. Imagine.
 *
 * David 2026-09-08 moved the studio's front door to the Step Flow (see
 * pages/CreatorStudio.tsx, "our customers should have the same flow"). This
 * page is still reachable from a link on it: talking a build out loud is a
 * genuinely different way to work and there was no reason to delete it.
 *
...
export default function CreatorStudioVoice() {
  const { user } = useAuth()
