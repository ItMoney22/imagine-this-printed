...
interface LeftSidebarProps {
  ...
  lastSaved?: Date
  presets?: any // Using any for now to avoid import chaos, or use the type we just added if imported
}
    ...
    <>
      ...
      <aside className="w-72 bg-card border-r border-primary/20 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Sheet Presets */}
          <div className="p-4 border-b border-primary/20">
            <SheetPresets sheet={sheet} onSheetChange={onSheetChange} presets={presets} />
          </div>
